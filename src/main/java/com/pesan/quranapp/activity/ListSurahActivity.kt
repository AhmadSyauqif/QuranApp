...
import com.pesan.quranapp.adapter.SurahAdapter
import com.pesan.quranapp.fragment.JadwalShalatFragment.Companion.newInstance
import com.pesan.quranapp.model.ModelSurah
import com.pesan.quranapp.network.Api
...
class ListSurahActivity : AppCompatActivity(), SurahAdapter.onSelectData1 {
    ...
    private var fusedLocationClient: FusedLocationClient? = null
